...
namespace GestionTurnosUTN.Data.Migrations.Authenticate
{
    /// <inheritdoc />
    public partial class InitialModelAuthenticate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudenId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Usuarios_Students_StudenId",
                        column: x => x.StudenId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Usuarios_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usuarios_StudenId",
                table: "Usuarios",
                column: "StudenId",
                unique: true,
                filter: "[StudenId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Usuarios_WorkerId",
                table: "Usuarios",
                column: "WorkerId",
                unique: true,
